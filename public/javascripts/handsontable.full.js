        ...
        if (checkColumnHeader(e.target)){
          ...
          if (th) {
              if (pressed) {
                  ...
                  console.info("mouseover col :", col);
                  if(col >= 2)//add by zhy
                  {
    ...
    eventManager.addEventListener(window,'mouseup',function (e) {
      if (pressed) {
        ...
        pressed = false;
            ...
            console.info("movecol startcol: ", startCol, "endCol:", endCol);
          if(startCol >= 2 && endCol >= 2)//zhy
          {
    ...
    var bindEvents = function () {
        ...
        if(checkRowHeader(e.target)){
          ...
          if (th) {
            if (pressed) {
              ...
              if(endRow >= 2)//add by zhy
              {
                refreshHandlePosition(th, endRow - startRow);
            }
            */
                var row = instance.view.wt.wtTable.getCoords(th).row;
                if(row >= 2)
                {
                    endRow = row;
                    refreshHandlePosition(th, endRow - startRow);
      ...
      eventManager.addEventListener(window,'mouseup',function (e) {
        if (pressed) {
          hideHandleAndGuide();
          pressed = false;
            console.info("moveRow startRow: ", startRow, "endRow:", endRow);
          if(endRow >= 2 && startRow >= 2)//zhy
          {
